...
- ApiController를 컨트롤러에 적용함으로써 다양한 API 관련 동작 사용 가능
    ...
    - 기본적인 웹 API 동작이 자동 구성되기 때문에 코드를 간소화할 수 있다다
...
- 서비스를 직접 클래스 내에서 만들어서 쓰는게 아니고 밖에서 제공받아서 사용하는 것것
...
<img src='https://drive.google.com/uc?export=download&id=1MqeNJ9y_cQOqmBDGhRdLQ6AwtOdieT91' width="1000" /><br>
